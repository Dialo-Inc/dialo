      ...
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          <div className="md:col-span-2">
            <div className="mb-6">
              <h3 className="text-2xl font-bold mb-2">AI Voice Agent Platform</h3>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-slate-400">
          ...
          <div className="text-center md:text-right">
            <p>&copy; 2024 AI Voice Agent Platform. All rights reserved.</p>
            <p className="text-sm mt-1">Built with cutting-edge AI technology for automotive excellence.</p>
          </div>
        </div>
        
        <div className="mt-8 text-center">
          <div className="inline-flex items-center gap-2 bg-slate-800 rounded-full px-6 py-3">
