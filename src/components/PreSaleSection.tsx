...
const PreSaleSection = () => {
  ...
  return <section className="py-12 sm:py-20 bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 text-white relative overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 sm:px-6">
        ...
        <div className="max-w-4xl mx-auto grid lg:grid-cols-2 gap-8 sm:gap-12 items-start mb-12 sm:mb-16">
          ...
          <Card className="bg-gradient-to-br from-teal-500/20 to-blue-500/20 border-teal-500/30 text-white">
            <CardHeader>
              <CardTitle className="text-xl text-center text-gray-600 sm:text-2xl">Founding Member Benefits</CardTitle>
            </CardHeader>
            <CardContent>
              ...
              <div className="text-center space-y-4">
                <div className="bg-white/10 rounded-lg p-4">
                  ...
                  <div className="text-sm text-slate-300 bg-transparent">Lifetime price lock guaranteed</div>
                </div>
